...
const NavBar = () => {
  ...
  let { setLoggedIn, loggedIn } = useContext(Auth);
  ...
  return (
    ...
    ${
      isActive
        ...
        : "text-gray-300 hover:text-lime-400 after:w-0 hover:after:w-full"
    }`
            }
          >
            Home
      ...
      isActive
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="flex items-center gap-2 rounded-md border border-zinc-700 bg-[#151515] px-2 py-1 transition-all duration-300 hover:border-lime-400 hover:bg-zinc-900">
            ...
            <span className="text-[13px] text-zinc-200">{loggedIn.name}</span>
          </button>
          ...
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-md border border-zinc-700 bg-[#151515] text-zinc-300 transition-all duration-300 hover:scale-105 hover:border-lime-400 hover:bg-zinc-900 hover:text-lime-400"
          >
